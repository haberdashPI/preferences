...
keybindings: {
    ...
    "::doc::,n": {kind: "action", label: "→ conflict", detail: "move to next merge conflict (merge editor)"},
    ",n": "merge.goToNextConflict",
    "::doc::,N": {kind: "action", label: "← conflict", detail: "move to previous merge conflict (merge editor)"},
