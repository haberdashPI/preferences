...
docTips: [
    ...
    { 
        ...
        entries: [
            ...
            { title: "Git", id: "git" },
            { title: "Merge Conflicts", id: "merge_conflict" }
        ]
    },
    {
        title: "Interface", 
        ...
        entries: [
            ...
            { title: "Debugging", id: "debug" },
            { title: "Move to Annotations", id: "note_motions"},
            { title: "Bookmark Navigation", id: "bookmarks"},
            { title: "Window Navigation", id: "window_motion"},
            { title: "Window Manipulation", id: "window_manip"},
            { title: "Miscellaneous", id: "window_misc"},
        ]
    },
    { 
...
keybindings: {
    ...
    "::doc::'u": { kind: "select", label: "pluto cell →", detail: "next pluto cell", tip: "region" },
    "::doc::'U": { kind: "select", label: "pluto cell ←", detail: "previous pluto cell", tip: "region" },
    ...
    "::using::selection-utilities.moveBy": {
        ...
        uP:  { unit: "paragraph",  boundary: "start",  selectWhole: true, value: '-(__count || 1)' },
        "'u":  { unit: "pluto_cell", boundary: "start", selectWhole:      true, value: '(__count || 1)'  },
        "'U":  { unit: "pluto_cell", boundary: "start", selectWhole:      true, value: '-(__count || 1)' },
    ...
    // ### git/version control
    "::doc::gr": {kind: "action", label: "git stage", detail: "stage changes for commit", tip: "git"},
    gr: countSelectsLines([ "git.stageSelectedRanges", "modalkeys.touchDocument", "modalkeys.cancelMultipleSelections" ]),
    "::doc::gR": {kind: "action", label: "git unstage", detail: "unstage changes for commit", tip: "git"},
    gR: countSelectsLines([ "git.unstageSelectedRanges", "modalkeys.touchDocument", "modalkeys.cancelMultipleSelections" ]),
    "::doc::gu": {kind: "action", label: "git revert", detail: "revert uncommited changes", tip: "git"},
    gu: countSelectsLines(["git.revertSelectedRanges", "modalkeys.cancelMultipleSelections"]),
    "::doc::gl": {kind: "action", label: "git pull", detail: "pull changes from remote", tip: "git"},
    gl: "git.pull",
    "::doc::gp": {kind: "action", label: "git push", detail: "push changes to remote", tip: "git"},
    gp: "git.push",
    
    "::doc::gc": {kind: "action", label: "→ conflict", detail: "move to next merge conflict", tip: "merge_conflict"},
    gc: "merge-conflict.next",
    "::doc::gC": {kind: "action", label: "← conflict", detail: "move to previous merge conflict", tip: "merge_conflict"},
    gC: "merge-conflict.previous",
    "::doc::g[": {kind: "action", label: "acpt current", detail: "accept current change", tip: "merge_conflict"},
    "g[": "merge-conflict.accept.current",
    "::doc::g]": {kind: "action", label: "acpt incoming", detail: "accept incoming change", tip: "merge_conflict"},
    "g]": "merge-conflict.accept.incoming",
    "::doc::g\\": {kind: "action", label: "acpt both", detail: "accept both changes", tip: "merge_conflict"},
    "g\\": "merge-conflict.accept.both",
    "::doc::g{": {kind: "action", label: "all current", detail: "accept all current changes", tip: "merge_conflict"},
    "g{": "merge-conflict.accept.all-current",
    "::doc::g}": {kind: "action", label: "all incoming", detail: "accept all incoming changes", tip: "merge_conflict"},
    "g}": "merge-conflict.accept.all-incoming",
    "::doc::g|": {kind: "action", label: "all both", detail: "accept all both changes", tip: "merge_conflict"},
    "g|": "merge-conflict.accept.all-both",
    "::doc::,n": {kind: "action", label: "→ conflict", detail: "move to next merge conflict (merge editor)", tip: "merge_conflict"},
    ",n": "merge.goToNextConflict",
    "::doc::,N": {kind: "action", label: "← conflict", detail: "move to previous merge conflict (merge editor)", tip: "merge_conflict"},
    ",N": "merge.goToPreviousConflict",
    "::doc::,[": {kind: "action", label: "acpt current", detail: "accept current change (merge editor)", tip: "merge_conflict"},
    ",[": "merge.toggleActiveConflictInput1",
    "::doc::,{": {kind: "action", label: "cmpr current", detail: "compare current change (merge editor)", tip: "merge_conflict"},
    ",{": "mergeEditor.compareInput1WithBase",
    "::doc::,]": {kind: "action", label: "acpt current", detail: "accept current change (merge editor)", tip: "merge_conflict"},
    ",]": "merge.toggleActiveConflictInput2",
    "::doc::,}": {kind: "action", label: "cmpr current", detail: "compare current change (merge editor)", tip: "merge_conflict"},
    ",}": "mergeEditor.compareInput2WithBase",
    "::doc::,e": {kind: "select", label: "error →", detail: "move to next error", tip: "merge_conflict"},

    ",e": "editor.action.marker.next",
    "::doc::,E": {kind: "select", label: "error ←", detail: "move to previous error", tip: "note_motions"},
    ",E": "editor.action.marker.prev",
    "::doc::,d": {kind: "window", label: "diff →", detail: "move to and show next change", tip: "note_motions"},
    ",d": "editor.action.dirtydiff.next",
    "::doc::,D": {kind: "window", label: "diff ←", detail: "move to and show previous change", tip: "note_motions"},
    ",D": "editor.action.dirtydiff.previous",
    "::doc::'d": {kind: "select", label: "change →", detail: "move to next change", tip: "note_motions"},
    "'d": "workbench.action.editor.nextChange",
    "::doc::'D": {kind: "select", label: "change ←", detail: "move to previous change", tip: "note_motions"},
    "'D": "workbench.action.editor.previousChange",

    // ### window manipulation
    "::doc::,>": { kind: "window", label: "center", detail: "center window at primary cursor position", tip: "window_motion"},
    ",>": { "revealLine": { lineNumber: '__line', at: 'center' } },
    "::doc::,K": { kind: "window", label: "top", detail: "center window so that primary cursor is at the top", tip: "window_motion"},
    ",K": { "revealLine": { lineNumber: '__line', at: 'top' } },
    "::doc::,J": { kind: "window", label: "bottom", detail: "center window so that primary cursor is at the bottom", tip: "window_motion"},
    ",J": { "revealLine": { lineNumber: '__line', at: 'bottom' } },
    "::doc::,M": { kind: "window", label: "max", detail: "minimize size of all other windows", tip: "window_motion"},
    ",M": "workbench.action.minimizeOtherEditors",
    "::doc::,=": { kind: "window", label: "equal", detail: "equalzize size of all windows", tip: "window_motion"},
    ",=": "workbench.action.evenEditorWidths",
    "::doc::,|": { kind: "window", label: "split", detail: "toggle split editor view", tip: "window_motion"},
    ",|": "workbench.action.toggleSplitEditorInGroup",
    "::doc::,L": { kind: "window", label: "split →", detail: "move to other side of editor split", tip: "window_motion"},
    ",L": "workbench.action.focusOtherSideEditor",
    "::doc::,l": { kind: "window", label: "→", detail: "move focus to window to the right", tip: "window_motion"},
    ",l": "workbench.action.focusRightGroup",
    "::doc::,h": { kind: "window", label: "←", detail: "move focus to window to the left", tip: "window_motion"},
    ",h": "workbench.action.focusLeftGroup",
    "::doc::,k": { kind: "window", label: "↑", detail: "move focus to window above", tip: "window_motion"},
    ",k": "workbench.action.focusAboveGroup",
    "::doc::,j": { kind: "window", label: "↓", detail: "move focus to window below", tip: "window_motion"},
    ",j": "workbench.action.focusBelowGroup",
    "::doc::,c": { kind: "window", label: "create", detail: "create new window of editor in given direction" , tip: "window_manip"},
    "::doc::,cl": { kind: "window", label: "→", detail: "create new window of editor to left" , tip: "window_manip"},
    ",cl": "workbench.action.splitEditorRight",
    "::doc::,ch": { kind: "window", label: "←", detail: "create new window of editor to left" , tip: "window_manip"},
    ",ch": "workbench.action.splitEditorLeft",
    "::doc::,cj": { kind: "window", label: "↓", detail: "create new window of editor below" , tip: "window_manip"},
    ",cj": "workbench.action.splitEditorDown",
    "::doc::,ck": { kind: "window", label: "↑", detail: "create new window of editor above" , tip: "window_manip"},
    ",ck": "workbench.action.splitEditorUp",
    "::doc::,m": { kind: "window", label: "move to", detail: "move editor to window in given direction" , tip: "window_manip"},
    "::doc::,ml": { kind: "window", label: "→", detail: "move editor to window to left" , tip: "window_manip"},
    ",ml": "workbench.action.moveEditorToRightGroup",
    "::doc::,mh": { kind: "window", label: "←", detail: "move editor to window to left" , tip: "window_manip"},
    ",mh": "workbench.action.moveEditorToLeftGroup",
    "::doc::,mj": { kind: "window", label: "↓", detail: "move editor to window below" , tip: "window_manip"},
    ",mj": "workbench.action.moveEditorToBelowGroup",
    "::doc::,mk": { kind: "window", label: "↑", detail: "move editor to window above" , tip: "window_manip"},
    ",mk": "workbench.action.moveEditorToAboveGroup",
    "::doc::,x": { kind: "window", label: "close pane", detail: "close the given group of editors", tip: "window_manip"},
    ",x": "workbench.action.closeEditorsInGroup",

    "::doc::gh": { kind: "window", label: "hover", detail: "show the hover view", tip: "window_misc" },
    gh: "editor.action.showHover",
    "::doc::gf": { kind: "window", label: "open", detail: "open the file name under the cursor", tip: "window_misc" },
    gf: "extension.openFileFromPath",
    "::doc::gd": { kind: "window", label: "go to", detail: "go to the definition of symbol under curosr", tip: "window_misc" },
    gd: "editor.action.revealDefinition",
    "::doc::gD": { kind: "window", label: "go to (aside)", detail: "go to the definition of symbol under curosr in an editor to the side", tip: "window_misc" },
    gD: "editor.action.revealDefinitionAside",

    // ### Debugging
    "::doc::gH": { kind: "window", label: "debug hover", detail: "show the debug hover view", tip: "debug" },
    gH: "editor.debug.action.showDebugHover",
    "::doc::gb": { kind: "action", label: "breakpt.", detail: "toggle debug breakpoint", tip: "debug" },
    gb: "editor.debug.action.toggleBreakpoint",
    "::doc::ge": { kind: "leader", label: "debug", detail: "additional debug actions", tip: "debug" },
    geb: "editor.debug.action.conditionalBreakpoint",
    "::doc::ger": { kind: "action", label: "start", detail: "start debugging", tip: "debug" },
    ger: "workbench.action.debug.start",
    "::doc::gec": { kind: "action", label: "continue", detail: "continue debugging", tip: "debug" },
    gec: "workbench.action.debug.continue",
    "::doc::gej": { kind: "action", label: "next", detail: "debug: step over next line", tip: "debug" },
    gej: "workbench.action.debug.stepOver",
    "::doc::gel": { kind: "action", label: "into", detail: "debug: step into next line", tip: "debug" },
    gel: "workbench.action.debug.stepInto",
    "::doc::gek": { kind: "action", label: "out", detail: "debug: step out", tip: "debug" },
    gek: "workbench.action.debug.stepOut",

    // ### bookmarks
    "::doc::g ": { kind: "action", label: "mark", detail: "toggle bookmark at given line (use 'j, 'k and '# to navigate bookmarks)", tip: "bookmarks" },
    "g ": "vsc-labeled-bookmarks.toggleBookmark",
    "::doc::'j": { kind: "action", label: "mark ↓", detail: "move to next bookmark", tip: "bookmarks" },
    "normal::'j": "vsc-labeled-bookmarks.navigateToNextBookmark",
    "::doc::'k": { kind: "action", label: "mark ↑", detail: "move to previous bookmark", tip: "bookmarks" },
    ...
    "::doc::gx ": { kind: "action", label: "mark", detail: "remove bookmark (use quick selection)", tip: "bookmarks" },
    "gx ": "vsc-labeled-bookmarks.deleteBookmark",
    "::doc::'#": { kind: "select", label: "nav marks", detail: "reveal quick selection to move to a bookmark", tip: "bookmarks" },
    "'#": "vsc-labeled-bookmarks.navigateToBookmark",

    // TODO: stopped updating doc tips here
