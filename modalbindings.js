...
keybindings: {
    ...
    "::doc::,t": { kind: "window", label: "move to", detail: "move editor to window in given direction" },
    "::doc::,tl": { kind: "window", label: "→", detail: "move editor to window to left" },
    ",tl": "workbench.action.moveEditorToRightGroup",
    "::doc::,th": { kind: "window", label: "←", detail: "move editor to window to left" },
    ",th": "workbench.action.moveEditorToLeftGroup",
    "::doc::,tj": { kind: "window", label: "↓", detail: "move editor to window below" },
    ",tj": "workbench.action.moveEditorToBelowGroup",
    "::doc::,tk": { kind: "window", label: "↑", detail: "move editor to window above" },
    ",tk": "workbench.action.moveEditorToAboveGroup",
