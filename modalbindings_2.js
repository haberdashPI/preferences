module.exports = {keybindings: {
    ...
    // buffer related
    $: { "editor.action.selectAll": {}, bg: "#084", label: "everything" },
    "'j": { "cursorBottomSelect": {}, bg: "#084", label: "to bottom" },
    "'k": { "cursorTopSelect": {}, bg: "#084", label: "to top" },
    ...
    // check
    "^": { "markdown-checkbox.markCheckbox": {}, label: "chckbox" },

    "ga": { "selection-utilities.trimWhitespace": {}, label: "trim wht"},
